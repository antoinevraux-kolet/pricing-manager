...
export function pctDelta(before: number | null, after: number | null): number | null {
...
export function DeltaBadge({ delta, positiveIsGood = true }: { delta: number | null; positiveIsGood?: boolean }) {
